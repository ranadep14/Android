...
/**************NEW***/
        ...
        //if(App.is) {
        SharedPreferences sharedPreferences=context.getSharedPreferences("Delos-welltek",Context.MODE_PRIVATE);
        if(sharedPreferences.contains("time_fomat")) {
            String timeFormate=sharedPreferences.getString("time_fomat","");
            if (timeFormate.equals("1")) {
