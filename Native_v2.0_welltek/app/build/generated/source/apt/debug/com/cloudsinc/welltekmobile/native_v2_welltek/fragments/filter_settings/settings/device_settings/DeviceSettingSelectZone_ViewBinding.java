...
public class DeviceSettingSelectZone_ViewBinding implements Unbinder {
  private DeviceSettingSelectZone target;

  private View view2131296670;

  @UiThread
  public DeviceSettingSelectZone_ViewBinding(final DeviceSettingSelectZone target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    DeviceSettingSelectZone target = this.target;
