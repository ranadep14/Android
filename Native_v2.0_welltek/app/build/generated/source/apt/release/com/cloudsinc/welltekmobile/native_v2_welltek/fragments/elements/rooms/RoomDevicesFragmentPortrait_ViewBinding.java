...
public class RoomDevicesFragmentPortrait_ViewBinding implements Unbinder {
  private RoomDevicesFragmentPortrait target;
  ...
  @UiThread
  public RoomDevicesFragmentPortrait_ViewBinding(final RoomDevicesFragmentPortrait target,
      View source) {
    this.target = target;
    ...
    target.lin_light_list = Utils.findOptionalViewAsType(source, R.id.lin_light_list, "field 'lin_light_list'", LinearLayout.class);
    target.lin_light_group_list = Utils.findOptionalViewAsType(source, R.id.lin_light_group_list, "field 'lin_light_group_list'", LinearLayout.class);
    target.lin_hvac_list = Utils.findOptionalViewAsType(source, R.id.lin_hvac_list, "field 'lin_hvac_list'", LinearLayout.class);
    target.lin_music_list = Utils.findOptionalViewAsType(source, R.id.lin_music_list, "field 'lin_music_list'", LinearLayout.class);
    target.lin_blind_list = Utils.findOptionalViewAsType(source, R.id.lin_blind_list, "field 'lin_blind_list'", LinearLayout.class);
    target.lin_blind_group_list = Utils.findOptionalViewAsType(source, R.id.lin_blind_group_list, "field 'lin_blind_group_list'", LinearLayout.class);
    target.rec_lights = Utils.findOptionalViewAsType(source, R.id.rec_lights, "field 'rec_lights'", RecyclerView.class);
    target.rec_blinds = Utils.findOptionalViewAsType(source, R.id.rec_blinds, "field 'rec_blinds'", RecyclerView.class);
    target.rec_music = Utils.findOptionalViewAsType(source, R.id.rec_audio, "field 'rec_music'", RecyclerView.class);
    target.rec_blinds_group = Utils.findOptionalViewAsType(source, R.id.rec_blinds_group, "field 'rec_blinds_group'", RecyclerView.class);
    target.rec_lights_group = Utils.findOptionalViewAsType(source, R.id.rec_lights_group, "field 'rec_lights_group'", RecyclerView.class);
    target.rec_hvac = Utils.findOptionalViewAsType(source, R.id.rec_hvac, "field 'rec_hvac'", RecyclerView.class);
    target.txt_room_title = Utils.findOptionalViewAsType(source, R.id.txt_room_title, "field 'txt_room_title'", TextView.class);
    target.img_room_type = Utils.findOptionalViewAsType(source, R.id.img_room_type, "field 'img_room_type'", ImageView.class);
    target.rel_whole_home = Utils.findOptionalViewAsType(source, R.id.rel_whole_home, "field 'rel_whole_home'", RelativeLayout.class);
    target.txt_room_id = Utils.findOptionalViewAsType(source, R.id.txt_room_id, "field 'txt_room_id'", TextView.class);
    target.txt_room_type = Utils.findOptionalViewAsType(source, R.id.txt_room_type, "field 'txt_room_type'", TextView.class);
    target.lin_device_container = Utils.findOptionalViewAsType(source, R.id.lin_device_container, "field 'lin_device_container'", LinearLayout.class);
    ...
    target.circular_whole_home_on_off = Utils.findOptionalViewAsType(source, R.id.circular_whole_home_on_off, "field 'circular_whole_home_on_off'", ProgressBar.class);
    target.txt_no_devices = Utils.findOptionalViewAsType(source, R.id.txt_no_devices, "field 'txt_no_devices'", TextView.class);
    ...
    view = Utils.findRequiredView(source, R.id.img_option, "field 'img_option'");
    ...
    view = source.findViewById(R.id.img_all_fav);
    if (view != null) {
      view2131296669 = view;
      view.setOnClickListener(new DebouncingOnClickListener() {
        @Override
  ...
  @CallSuper
  public void unbind() {
    RoomDevicesFragmentPortrait target = this.target;
    ...
    view2131296715 = null;
    view2131297603.setOnClickListener(null);
    view2131297603 = null;
    if (view2131296669 != null) {
