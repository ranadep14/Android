...
public class IndoorTabletnew_ViewBinding implements Unbinder {
  private IndoorTabletnew target;
  ...
  @UiThread
  public IndoorTabletnew_ViewBinding(final IndoorTabletnew target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    IndoorTabletnew target = this.target;
    ...
    view2131296263 = null;
    view2131297334.setOnClickListener(null);
    view2131297334 = null;
