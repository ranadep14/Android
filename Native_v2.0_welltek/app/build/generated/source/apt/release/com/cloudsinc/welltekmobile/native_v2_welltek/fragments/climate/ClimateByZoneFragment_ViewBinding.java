...
public class ClimateByZoneFragment_ViewBinding implements Unbinder {
  private ClimateByZoneFragment target;
  ...
  @UiThread
  public ClimateByZoneFragment_ViewBinding(final ClimateByZoneFragment target, View source) {
    this.target = target;
    ...
    target.seek_range_comfort_band = Utils.findOptionalViewAsType(source, R.id.seek_range_comfort_band, "field 'seek_range_comfort_band'", RangeSeekBar.class);
  ...
  @CallSuper
  public void unbind() {
    ClimateByZoneFragment target = this.target;
    ...
    target.seek_range_comfort_band = null;
