...
public class WaterNotification_ViewBinding implements Unbinder {
  private WaterNotification target;

  private View view2131296670;

  @UiThread
  public WaterNotification_ViewBinding(final WaterNotification target, View source) {
    this.target = target;
    ...
    target.edt_replace_water = Utils.findRequiredViewAsType(source, R.id.edt_replace_water, "field 'edt_replace_water'", TextView.class);
  ...
  @CallSuper
  public void unbind() {
    WaterNotification target = this.target;
    if (target == null) throw new IllegalStateException("Bindings already cleared.");
    this.target = null;

    target.txt_save = null;
    target.spn_notifer = null;
    target.edt_replace_water = null;
