...
public class ScheduleService extends Service {
	 ...
	 */
	public void setAlarm(Calendar c, String dawn_id, String dawn_room_name, String notif_type, int id, int notif_day_name,int mode) {
		// This starts a new thread to set the alarm
		// You want to push off your tasks onto a new thread to free up the UI to carry on responding
		new AlarmTask(this, c,dawn_id,dawn_room_name,notif_type,id,notif_day_name,mode).run();
	}
}