...
/**
 * Created by developers on 25/10/17.
 */
...
public class GPSTracker extends Service implements LocationListener {
   ...
   /* public void showSettingsAlert(){
        ...
        alertDialog.setMessage("To continue, let your device turn on location.");
    ...
    public void showSettingsAlert(){
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(mContext);
        // Setting Dialog Title
        alertDialog.setTitle(mContext.getResources().getString(R.string.Location));
        // Setting Dialog Message
        alertDialog.setMessage(mContext.getResources().getString(R.string.LocationGPS));
        // On pressing Settings button
