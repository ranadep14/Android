...
/**
 * This class containing functionality related to displaying ssid list and select from those
 *
 * @author  nikhil vharamble
 * @version 1.0
 * @since   2017-11-8
 */
public class CustomSSIDAdapter extends BaseAdapter {
    private Context activity;
    private ArrayList<Ssid> ssidArrayList;
    private static LayoutInflater inflater=null;
    private Fragment fragment;
    private TextView txtsimid,txttime,txtdays,txtroomtype;
    private String TAG=CustomSSIDAdapter.this.getClass().getName();
    private Switch simstatus;
    public CustomSSIDAdapter(Context a, ArrayList<Ssid> mssidArrayList) {
        activity = a;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        txt_title.setText(ssidArrayList.get(position).getTitle());
        return vi;
    }
}