...
public class TimePickerFragment extends DialogFragment implements NumberPadTimePicker.OkButtonCallbacks {
...
*/
    ...
    public void onOkButtonClick(NumberPadTimePicker view, int hourOfDay, int minute) {
       ...
       // bundle.putString("Callfromm","edittime");
       ...
       /* if(new PrefManager(mcontext).getValue("time_fomat").equals("1")) {
        ...
        if(new PrefManager(mcontext).getValue("time_fomat").equals("1")) {
            ...
            App.setTemp_bundle(bundle);
          //  //Toast.makeText(mcontext, "24 Hour", Toast.LENGTH_SHORT).show();
            ...
            App.setTemp_bundle(bundle);
            ////Toast.makeText(mcontext, "12 Hour", Toast.LENGTH_SHORT).show();
        ...
        //ReplaceFragment.replaceFragment(this, R.id.frm_expriencesmain_container, Add_custmise_sleep.newInstance());
