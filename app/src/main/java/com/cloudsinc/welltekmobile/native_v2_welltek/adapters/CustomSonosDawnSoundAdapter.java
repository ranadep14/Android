...
public class CustomSonosDawnSoundAdapter extends BaseAdapter {
    ...
    public CustomSonosDawnSoundAdapter(Context a, ArrayList<Sound> chooseSoundArrayList, Fragment mfragment) {
        activity = a;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        GridLayout gidview=new GridLayout(activity);

        if(convertView==null)
            vi = inflater.inflate(R.layout.dawn_sonos_item, null);
...
//            SimulaterModel simulaterModel=data.get(position);
        ...
        if (boxState[position] == 0) {
           palypause.setImageDrawable(activity.getResources().getDrawable(R.drawable.ic_playlist_white));


        } else {
            palypause.setImageDrawable(activity.getResources().getDrawable(R.drawable.play_alarm_sound_waves));
...
public void onClick(View v) {
        ...
        //    soundState[pos]=0;
        tmp_img.setImageDrawable(activity.getResources()
        .getDrawable(R.drawable.ic_playlist_white));
